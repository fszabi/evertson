    ...
    <div class="container">
        <nav>
            <button class="preview" data-action="weapon_choose">
				<?php
				// Check if $currentWeapon is an object and if it has the weapon_name property
				if (is_object($currentWeapon) && property_exists($currentWeapon, 'weapon_name')) {
					// If weapon_name property exists, use it for alt attribute
					$altText = $currentWeapon->weapon_name;
				} else {
					// If weapon_name property doesn't exist, use a default alt text
					$altText = "Image for the weapon";
				}
				?>

				<!-- Use $altText for the alt attribute -->
				<img src="<?= $currentWeapon->image; ?>" alt="<?= htmlspecialchars($altText); ?>">
            </button>
            <div class="info">
                <p><strong>
                    <?php
